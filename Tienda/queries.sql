...
SELECT nombre, precio, precio * 1 AS precio_usd FROM producto;
...
SELECT nombre, precio AS 'euros' , ROUND (precio * 1.1, 2) AS 'dolar' FROM producto;
...
SELECT nombre, precio, ROUND (precio) AS redondeo FROM producto;
...
SELECT nombre, precio, ROUND (precio, 0) AS sinDecimales FROM producto;
...
JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo; -- ilegal lo mucho que me ha costado llegar a esto
...
fabricante.codigo AS codigo_fabricante FROM producto
JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo;
...
SELECT producto.nombre AS producto, producto.precio, fabricante.nombre AS fabricante FROM producto
JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo
WHERE producto.precio >= 180 ORDER BY producto.precio DESC, producto.precio ASC;
...
ORDER BY fabricante.nombre ASC, producto.nombre ASC;
